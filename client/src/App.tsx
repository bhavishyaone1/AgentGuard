...
export default function App() {
  // Active Page State
  const [currentPage, setCurrentPage] = useState<"platform" | "vulnerability" | "architecture" | "sandbox" | "scoring" | "sdk" | "faq">("platform");
  ...
  useEffect(() => {
    const handleScroll = () => {
      setNavbarShrunk(window.scrollY > 20);
    };
  ...
  return (
    <div className="min-h-screen text-text-primary flex flex-col relative overflow-hidden bg-[#050505] selection:bg-brand-violet selection:text-white">
      ...
      <header className={`fixed top-4 left-1/2 -translate-x-1/2 w-[94%] max-w-6xl rounded-full z-50 transition-all duration-300 ${
        ...
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => setCurrentPage("platform")}>
          <span className="font-extrabold text-sm tracking-tight font-display text-white">
            AgentGuard
          </span>
        </div>

        {/* Top Section View Switcher */}
      ...
      {/* Main Page Container */}
      <main className="w-full max-w-7xl mx-auto px-6 pt-32 pb-20 relative z-10 flex-1 flex flex-col justify-center">
          ...
          {navigationItems.map((item) => (
            <button
              ...
              className={`text-xs font-bold px-3 py-1.5 rounded-xl whitespace-nowrap transition-colors ${
                currentPage === item.id ? 'bg-brand-blue text-white' : 'bg-[#0D0D0D] text-text-secondary border border-white/5'
              }`}
            >
              {item.label}
            </button>
        ...
        {/* ============================================================ */}
        {/* VIEW 1: PLATFORM HERO & OVERVIEW                             */}
        {/* ============================================================ */}
        {currentPage === "platform" && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-6 animate-fade-in">
            {/* Left Column Text */}
        ...
        {/* ============================================================ */}
        {/* VIEW 2: SPEND VULNERABILITY VS SHIELD                        */}
        {/* ============================================================ */}
        {currentPage === "vulnerability" && (
          <div className="flex flex-col gap-12 py-4 animate-fade-in">
        ...
        {/* ============================================================ */}
        {/* VIEW 3: PROTOCOL ARCHITECTURE PIPELINE                      */}
        {/* ============================================================ */}
        {currentPage === "architecture" && (
          <div className="premium-card rounded-3xl p-10 border border-white/10 flex flex-col gap-10 animate-fade-in">
        ...
        {/* ============================================================ */}
        {/* VIEW 4: LIVE SECURITY SANDBOX CONSOLE                       */}
        {/* ============================================================ */}
        {currentPage === "sandbox" && (
          <div className="flex flex-col gap-8 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-bg-navy-light/60 border border-white/10 p-6 rounded-3xl backdrop-blur-md">
              <div>
                ...
                <h2 className="text-2xl md:text-3xl font-black text-white font-display mt-1">Autonomous AI Payment Firewall</h2>
        ...
        {/* ============================================================ */}
        {/* VIEW 5: ALGORITHMIC SCORING MATRIX                           */}
        {/* ============================================================ */}
        {currentPage === "scoring" && (
          <div className="flex flex-col gap-8 animate-fade-in">
            <div className="premium-card rounded-3xl p-8 md:p-10 border border-white/10">
              <div className="flex flex-col gap-2 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-white font-display">How AgentGuard Calculates Trust (0–100)</h2>
        ...
        {/* ============================================================ */}
        {/* VIEW 6: AI AGENT DROP-IN SDK                                 */}
        {/* ============================================================ */}
        {currentPage === "sdk" && (
          <div className="flex flex-col gap-8 animate-fade-in">
            <div className="premium-card rounded-3xl p-8 md:p-10 border border-white/10 flex flex-col gap-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <h2 className="text-3xl font-black text-white font-display mt-0.5">Multi-Framework Integration</h2>
...
def audit_merchant(merchant_address: str, price_base: str) -> str:
    ...
    return f"Verdict: {data['trust']['verdict'].upper()} (Score: {data['trust']['reputationScore']}/100)"`}
        ...
        {/* ============================================================ */}
        {/* VIEW 7: FAQ KNOWLEDGE BASE & SYSTEM FEATURES                */}
        {/* ============================================================ */}
        {currentPage === "faq" && (
