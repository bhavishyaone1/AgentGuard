...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<"console" | "scoring" | "sdk" | "architecture" | "faq">("console");
  ...
  const faqs = [
    ...
    { 
      ...
      a: "Wrap your agent's API tool with the AgentGuard security gate. Check the 'Developer SDK' tab above for copy-paste code snippets for LangChain, CrewAI, Python, and TypeScript." 
    }
  ];
  ...
  return (
    <div className="min-h-screen text-text-primary flex flex-col relative overflow-hidden bg-bg-navy selection:bg-brand-violet selection:text-white">
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 w-[94%] max-w-6xl rounded-full z-50 bg-bg-navy/80 border border-white/10 shadow-2xl py-3 px-6 backdrop-blur-xl flex justify-between items-center">
        ...
        {/* View Switcher Tabs */}
        <nav className="hidden md:flex items-center bg-bg-navy-dark/70 border border-white/10 p-1 rounded-full">
          {[
            { id: "console", label: "Security Console", icon: TerminalIcon },
            { id: "scoring", label: "Scoring Matrix", icon: Activity },
            { id: "sdk", label: "Developer SDK", icon: Code2 },
            { id: "architecture", label: "Architecture", icon: Layers },
            { id: "faq", label: "FAQ & Docs", icon: BookOpen }
          ].map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button 
                ...
                className={`text-xs font-semibold px-3.5 py-1.5 rounded-full transition-all flex items-center gap-1.5 cursor-pointer ${
                  isActive 
                    ? 'bg-white text-bg-navy-dark shadow-md font-bold' 
      ...
      {/* Main Container */}
      <main className="w-full max-w-7xl mx-auto px-6 pt-28 pb-20 relative z-10 flex-1 flex flex-col">
        
        {/* Mobile Tab Navigation */}
        <div className="flex md:hidden overflow-x-auto gap-2 pb-4 mb-4 border-b border-white/5">
          {[
            ...
            <button
              ...
              className={`text-xs font-bold px-3 py-1.5 rounded-xl whitespace-nowrap transition-colors ${
                activeTab === tab.id ? 'bg-brand-blue text-white' : 'bg-bg-navy-dark text-text-secondary border border-white/5'
              }`}
            >
              {tab.label}
            </button>
        ...
        {/* ============================================================ */}
        {/* TAB 1: SECURITY CONSOLE (THE INTERACTIVE TESTING SANDBOX)     */}
        {/* ============================================================ */}
        {activeTab === "console" && (
          <div className="flex flex-col gap-8 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-bg-navy-light/60 border border-white/10 p-6 rounded-3xl backdrop-blur-md">
              <div>
                <span className="text-[10px] font-bold text-brand-violet uppercase tracking-widest font-display">Live Testing Sandbox</span>
                <h1 className="text-2xl md:text-3xl font-black text-white font-display mt-1">Autonomous AI Payment Firewall</h1>
                <p className="text-xs text-text-secondary mt-1 max-w-xl">
                  Audit merchant trust against the Algorand Bazaar registry and enforce spend policies before signing transactions.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              {/* Left Column: Wallet & Spend Policy (5 cols) */}
              ...
              {/* Right Column: Query & Terminal Sandbox (7 cols) */}
                ...
                <div className="premium-card rounded-2xl p-6 flex flex-col gap-5">
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[10px] text-text-secondary leading-normal mt-1">
                      In AI commerce, a <b>Merchant</b> is any paid API or service. Select a preset to test:
                    </p>
                  </div>
        ...
        {/* ============================================================ */}
        {/* TAB 2: SCORING MATRIX DEEP-DIVE                              */}
        {/* ============================================================ */}
        {activeTab === "scoring" && (
          <div className="flex flex-col gap-8 animate-fade-in">
            <div className="premium-card rounded-3xl p-8 border border-white/10">
              <div className="flex flex-col gap-2 mb-8">
                <span className="text-[10px] font-bold text-brand-emerald uppercase tracking-widest font-display">Algorithmic Scoring Engine</span>
                <h2 className="text-3xl font-black text-white font-display">On-Chain Reputation Matrix (0–100)</h2>
                <p className="text-xs text-text-secondary max-w-2xl">
                  AgentGuard evaluates merchants deterministically using GoPlausible Bazaar registry indexes, historical settlement volumes, and declared price schemas.
                </p>
              </div>
              ...
              <div className="mt-8 bg-bg-navy-dark border border-brand-amber/20 rounded-2xl p-6 flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2 text-xs">
                  ...
                  <p className="text-text-secondary leading-relaxed">
                    AgentGuard implements a <b>Zero-Trust Security Architecture</b>. If an address is unregistered on the Algorand Bazaar index, has zero on-chain settlement history, or is an Ethereum/foreign-chain address (such as Tether <code>0xdac1...</code>), AgentGuard immediately assigns a <b>15/100 HIGH RISK</b> rating and instructs your AI agent to <b>ABORT</b> to prevent irreversible wallet drainage.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* ============================================================ */}
        {/* TAB 3: DEVELOPER SDK & MULTI-FRAMEWORK DROP-IN               */}
        {/* ============================================================ */}
        {activeTab === "sdk" && (
          <div className="flex flex-col gap-8 animate-fade-in">
            <div className="premium-card rounded-3xl p-8 border border-white/10">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <div>
                  ...
                  <p className="text-xs text-text-secondary mt-1">Wrap your AI agent's session to enforce spend limits & merchant checks automatically.</p>
                </div>
